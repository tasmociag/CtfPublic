                                ...
                                def ___________trippa_no_cap___________():
                                    def ____________tung_bussin_respectfully____________():
                                        def _____________tralalero_slay_queen_energy_____________():
                                            ...
                                            #1 arg 
                                                #                       "skibidi" "skibidi"
                                            __fanum_tax_pinguino____ = lambda x, y: ( lambda z: [c for c in z])   (
                                                [___x___ ^ ___y___ for ___x___, ___y___ in zip(x, __tung_tung_sahur_cycle_____(y))]
                                            )
